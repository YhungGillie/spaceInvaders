...
class AlienInvasion:
    ...
    def _update_bullets(self):
        """Update position if bullets and get rid of old bullets"""
    ...
    def _ship_hit(self):
        """Respond to th ship being hit by an alien"""
    ...
    def _create_alien(self, alien_number, row_number):
        """Create an alien and place it in the front row """
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
    ...
    def _check_fleet_edges(self):
        """Respond Approximately if any aliens have reached an edge"""
        for alien in self.aliens.sprites():
    ...
    def _update_screen(self):
        """Update images on their screen, and flip to the new screen"""
